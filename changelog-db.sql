...
--add collums to makeups table to inform about the room and duration of the makeup session
--changeset collard.yony:add-room-and-duration-to-makeups labels:Makeup
