...
async function handleCSVImport() {
  ...
  try {
    const response = await fetch("/Presenter/api/import-csv.php", {
      method: "POST",
      body: formData,
    });
  ...
  const interval = setInterval(async () => {
    try {
      const response = await fetch(
        `/Presenter/api/import-progress.php?import_id=${importId}`
      );
      const data = await response.json();
...
async function handleStudentsImport() {
  ...
  try {
    const response = await fetch("/Presenter/api/import-students.php", {
      method: "POST",
      body: formData,
    });
...
async function searchStudents(query) {
  ...
  try {
    const response = await fetch(
      `/Presenter/api/search-students.php?q=${encodeURIComponent(query)}`
    );
    const data = await response.json();
...
async function searchResources(query) {
  ...
  try {
    const response = await fetch(
      `/Presenter/api/search-resources.php?q=${encodeURIComponent(query)}`
    );
    const data = await response.json();
...
async function searchRooms(query) {
  ...
  try {
    const response = await fetch(
      `/Presenter/api/search-rooms.php?q=${encodeURIComponent(query)}`
    );
    const data = await response.json();
...
async function handleManualAbsenceSubmit(e) {
  ...
  try {
    const response = await fetch("/Presenter/api/create-manual-absence.php", {
      method: "POST",
      body: formData,
    });
...
async function handleCreateResource(form) {
  ...
  try {
    const response = await fetch("/Presenter/api/create-resource.php", {
      method: "POST",
      body: formData,
    });
...
async function handleCreateRoom(form) {
  ...
  try {
    const response = await fetch("/Presenter/api/create-room.php", {
      method: "POST",
      body: formData,
    });
...
async function loadImportHistory() {
  try {
    const response = await fetch("/Presenter/api/get-import-history.php");
    const data = await response.json();
