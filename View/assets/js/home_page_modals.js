...
document.addEventListener('DOMContentLoaded', function() {
    ...
    absenceRows.forEach(row => {
        row.addEventListener('click', function() {
            ...
            document.getElementById('absenceModalDuration').textContent = duration + 'h';
            document.getElementById('absenceModalEvaluation').textContent = evaluation;

            // Gérer le code du cours
            if (courseCode && courseCode.trim() !== '') {
                document.getElementById('absenceCourseCodeItem').style.display = 'flex';
                document.getElementById('absenceModalCourseCode').textContent = courseCode;
            } else {
    ...
    proofRows.forEach(row => {
        row.addEventListener('click', function() {
            ...
            document.getElementById('proofModalAbsences').textContent = absences + ' absence' + (absences > 1 ? 's' : '');
            ...
            if (customReason && customReason.trim() !== '') {
                ...
                document.getElementById('proofModalCustomReason').textContent = customReason;
            } else {
    ...
    // Fermer les modals
    closeAbsenceModalBtn.addEventListener('click', () => closeModal(absenceModal));
