...
require_once __DIR__ . '/../../../Presenter/academic_manager/historique_absence.php';
    ...
    <main>
        ...
        <form method="POST" action="">
            ...
            <div class="button-container">
                ...
                <a href="historique_absence.php" class="btn btn-secondary">
                    Réinitialiser
                </a>
            </div>
        </form>
                ...
                <?php else: ?>
                    <?php foreach ($absences as $absence): ?>
                        <tr class="<?php echo $absence['status'] ? 'status-justified' : 'status-unjustified'; ?>">
                            ...
                            <td data-label="Cours"><?php echo htmlspecialchars(formatResourceLabel($absence['course'])); ?></td>
