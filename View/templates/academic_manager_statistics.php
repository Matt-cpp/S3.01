...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/academic_manager_statistics.css">
...
<body>
    ...
    require_once __DIR__ . '/../../Presenter/academic-manager-statistics-presenter.php';
    ...
    <script>
        ...
        function searchStudent() {
            ...
            searchTimeout = setTimeout(() => {
                fetch(`../../Presenter/api/search-students.php?q=${encodeURIComponent(query)}`)
