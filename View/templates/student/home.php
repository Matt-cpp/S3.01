...
<body data-page="student_home">
    ...
    <div class="dashboard-container">
        ...
        <<<<<<< HEAD <!-- Statut des justificatifs (groupé en haut pour visibilité) -->
            ...
            <<<<<<< HEAD <!-- Alerte si demi-journées non justifiées -->
                =======
                <!-- Proof status -->
                <div class="proofs-status-section">
                    <h2 class="section-heading">
                    ...
                    <div class="proofs-grid">
                        <a href="proofs.php?status=accepted" class="proof-card proof-accepted">
                            ...
                            <div class="proof-content">
                                <div class="proof-count"><?php echo $stats['accepted_proofs']; ?></div>
                                <div class="proof-label" data-translate="accepted">Acceptés</div>
                                <div class="proof-description" data-translate="validated_proofs">Justificatifs validés
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="proofs.php?status=pending" class="proof-card proof-pending">
                            ...
                            <div class="proof-content">
                                <div class="proof-count"><?php echo $stats['pending_proofs']; ?></div>
                                <div class="proof-label" data-translate="pending">En attente</div>
                                <div class="proof-description" data-translate="under_review_desc">En cours d'examen
                                </div>
                            </div>
                        </a>
                                ...
                                <tbody>
                                    <?php foreach (array_slice($recentAbsences, 0, 5) as $absence): ?>
                                        ...
                                        <tr class="clickable-row absence-row" style="cursor: pointer;"
                                            ...
                                            <td data-label="Date">
                                                <?php echo date('d/m/Y', strtotime($absence['course_date'])); ?></td>
                                            ...
                                            <td data-label="Cours" class="course-cell">
                                                <div class="course-info">
                                                    <?php if (!empty($absence['course_code'])): ?>
                                                        <span
                                                            class="course-code"><?php echo htmlspecialchars($absence['course_code']); ?></span>
                                                    <?php endif; ?>
                                                    <?php if ($absence['course_name']): ?>
                                                        <span
                                                            class="course-name"><?php echo htmlspecialchars($absence['course_name']); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                            </td>
                    ...
                    <div class="absences-section">
                        <h2 class="section-title">
                            <span class="status-badge status-under-review"
                                data-translate="proofs_under_review">Justificatifs en
                                révision</span>
                        </h2>
                    ...
                    <div class="absences-section">
                        <h2 class="section-title">
                            <span class="status-badge status-pending"
                                data-translate="proofs_pending_validation">Justificatifs en
