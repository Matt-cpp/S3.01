...
<body>
    ...
    <main>
        ...
        <div class="manager-comment-section" style="background-color: #fff3cd; border: 2px solid #ffc107; border-radius: 8px; padding: 15px; margin-bottom: 20px;">
        ...
        <div class="form-group">
            ...
            <input type="datetime-local" id="datetime_start" name="datetime_start"
                   value="<?php echo htmlspecialchars($editData['datetime_start']); ?>"
        ...
        <div class="form-group">
            ...
            <input type="datetime-local" id="datetime_end" name="datetime_end"
                   value="<?php echo htmlspecialchars($editData['datetime_end']); ?>"
                   readonly style="background-color: #e9ecef; cursor: not-allowed;" required>
            <p class="help-text" style="color: #6c757d;">Les dates ne peuvent pas être modifiées</p>
        </div>
        ...
        <div class="form-group">
            ...
            <select id="absence_reason" name="absence_reason" onchange="toggleCustomReason()" required>
                ...
                <option value="maladie" <?php echo ($editData['absence_reason'] === 'illness') ? 'selected' : ''; ?>>Maladie</option>
                <option value="deces" <?php echo ($editData['absence_reason'] === 'death') ? 'selected' : ''; ?>>Décès dans la famille</option>
                <option value="obligations_familiales" <?php echo ($editData['absence_reason'] === 'family_obligations') ? 'selected' : ''; ?>>Obligations familiales</option>
                <option value="rdv_medical" <?php echo ($editData['absence_reason'] === 'other' && strpos(strtolower($editData['other_reason'] ?? ''), 'médical') !== false) ? 'selected' : ''; ?>>Rendez-vous médical</option>
        ...
        <div class="form-group" id="custom_reason" style="<?php echo ($editData['absence_reason'] === 'other' && !empty($editData['other_reason'])) ? 'display: block;' : 'display: none;'; ?>">
        ...
        <div class="form-group">
            ...
            <div style="margin-bottom: 10px; padding: 10px; background-color: #d1ecf1; border: 1px solid #bee5eb; border-radius: 4px;">
                <strong>📎 Fichier actuel :</strong>
                <a href="../../<?php echo htmlspecialchars($editData['existing_file_path']); ?>"
                   target="_blank" style="color: #0056b3;">
        ...
        <div class="form-group">
            ...
            <a href="student_absences.php" class="submit-btn" style="background-color: #6c757d; text-decoration: none; display: inline-block; text-align: center; margin-left: 10px;">Annuler</a>
        </div>
        </form>
    </main>
</body>
