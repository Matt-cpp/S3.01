    ...
    <div class="main-content">
            ...
            <form method="GET" class="filter-group">
                ...
                <?php if (isset($_GET['filtre']) && !empty($_GET['filtre'])): ?>
                    <a href="?reset_filtre=1" class="btn-primary"
                        style="padding: 0.5rem 1rem; font-size: 12px; text-decoration: none;" data-translate="reset">Réinitialiser</a>
                <?php endif; ?>
            </form>
            ...
            <table class="table">
                ...
                <tbody>
                    <?php if (empty($donnees)): ?>
                        <tr>
                            <td colspan="5" style="text-align: center; padding: 2rem; color: #666;" data-translate="no_absence_found">
            ...
            <?php if ($table->getNombrePages() > 1): ?>
                <div style="display: flex; justify-content: center; align-items: center; gap: 1rem; margin-top: 1.5rem;">
                    <a href="?page=<?php echo $table->getPreviousPage(); ?><?php echo isset($_GET['filtre']) ? '&filtre=' . urlencode($_GET['filtre']) : ''; ?>"
                        class="btn-primary"
                        style="padding: 0.5rem 1rem; font-size: 14px; text-decoration: none; <?php echo ($table->getCurrentPage() == 0) ? 'opacity: 0.5; pointer-events: none;' : ''; ?>" data-translate="previous">
                        Précédent
                    </a>
                    <span style="font-weight: 500; color: #333;">
                        <span data-translate="page">Page</span> <?php echo ($table->getCurrentPage() + 1); ?> <span data-translate="of">sur</span> <?php echo $table->getNombrePages(); ?>
                    </span>
                    <a href="?page=<?php echo $table->getNextPage(); ?><?php echo isset($_GET['filtre']) ? '&filtre=' . urlencode($_GET['filtre']) : ''; ?>"
                        class="btn-primary"
                        style="padding: 0.5rem 1rem; font-size: 14px; text-decoration: none; <?php echo ($table->getCurrentPage() >= $table->getNombrePages() - 1) ? 'opacity: 0.5; pointer-events: none;' : ''; ?>" data-translate="next">
                        Suivant
                    </a>
                </div>
            <?php endif; ?>
        ...
        <div class="section">
            <div class="section-header">
                ...
                <a href="planifier_rattrapage.php" class="btn-primary" style="text-decoration: none;" data-translate="schedule_makeup">Planifier un
                    rattrapage</a>
            </div>

            <h3 style="font-size: 1.1rem; font-weight: 600; margin-bottom: 1rem;" data-translate="students_makeup">Étudiants à rattraper</h3>
            ...
            <table class="table">
                ...
                <tbody>
                    <?php if (empty($donneesRattrapage)): ?>
                        <tr>
                            <td colspan="3" style="text-align: center; padding: 2rem; color: #666;" data-translate="no_student_makeup">
            ...
            <?php if ($tableRattrapage->getNombrePages() > 1): ?>
                <div style="display: flex; justify-content: center; align-items: center; gap: 1rem; margin-top: 1.5rem;">
                    <a href="?page_rattrapage=<?php echo $tableRattrapage->getPreviousPage(); ?><?php echo isset($_GET['page']) ? '&page=' . $_GET['page'] : ''; ?><?php echo isset($_GET['filtre']) ? '&filtre=' . urlencode($_GET['filtre']) : ''; ?>"
                        class="btn-primary"
                        style="padding: 0.5rem 1rem; font-size: 14px; text-decoration: none; <?php echo ($tableRattrapage->getCurrentPage() == 0) ? 'opacity: 0.5; pointer-events: none;' : ''; ?>" data-translate="previous">
                        Précédent
                    </a>
                    <span style="font-weight: 500; color: #333;">
                        <span data-translate="page">Page</span> <?php echo ($tableRattrapage->getCurrentPage() + 1); ?> <span data-translate="of">sur</span>
                    ...
                    <a href="?page_rattrapage=<?php echo $tableRattrapage->getNextPage(); ?><?php echo isset($_GET['page']) ? '&page=' . $_GET['page'] : ''; ?><?php echo isset($_GET['filtre']) ? '&filtre=' . urlencode($_GET['filtre']) : ''; ?>"
                        class="btn-primary"
                        style="padding: 0.5rem 1rem; font-size: 14px; text-decoration: none; <?php echo ($tableRattrapage->getCurrentPage() >= $tableRattrapage->getNombrePages() - 1) ? 'opacity: 0.5; pointer-events: none;' : ''; ?>" data-translate="next">
                        Suivant
                    </a>
                </div>
            <?php endif; ?>
