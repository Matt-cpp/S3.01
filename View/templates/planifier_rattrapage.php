...
<body>
    <header class="header">
        <div class="logo">
            <img src="data:image/png;base64,<?php echo base64_encode(file_get_contents(__DIR__ . '/../img/UPHF.png')); ?>" alt="UPHF Logo" />
        </div>
        ...
        <div class="section">
            ...
            <form action="" method="post">
                <div class="form-group">
                    ...
                    <select id="matiere" name="matiere" required onchange="this.form.querySelector('.form-help').textContent = this.options[this.selectedIndex].dataset.info || '';">
                        ...
                        <?php else: ?>
                            ...
                            ?>
                                <option value="<?php echo htmlspecialchars($ds['id']); ?>" 
                                    ...
                                    DS du <?php echo htmlspecialchars($ds['course_date']); ?> - ID: <?php echo htmlspecialchars($ds['id']); ?>
                                </option>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </select>
